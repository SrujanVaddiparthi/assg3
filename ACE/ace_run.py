...
def parse_arguments(argv):
    ...
    parser.add_argument('--model_to_run', type=str,
                        help='The name of the model.', default='ResNet50')  # Update default model name
    # No need for model_path since we're using pretrained weights
    parser.add_argument('--labels_path', type=str,
                        help='Path to model checkpoints.', default='./imagenet_labels.txt')
    parser.add_argument('--target_class', type=str,
                        help='The name of the target class to be interpreted', default='face')  # Update to 'face'
    parser.add_argument('--bottlenecks', type=str,
                        help='Names of the target layers of the network (comma separated)',
                        default='conv5_block3_out')  # Ensure this is set for ResNet
